...
static void init_packet(struct dhcpMessage *packet, char type)
{
...
#ifdef MS60
    #define VENDOR_STR_NETGEAR_MS60 "udhcp "VERSION" from NETGEAR MS60"
    #define VENDOR_STR VENDOR_STR_NETGEAR_MS60
#elif MS80
    #define VENDOR_STR_NETGEAR_MS80 "udhcp "VERSION" from NETGEAR MS80"
    #define VENDOR_STR VENDOR_STR_NETGEAR_MS80
#else
    #define VENDOR_STR "udhcp "VERSION
#endif 
	...
	} vendor_id = { DHCP_VENDOR,  sizeof(VENDOR_STR) - 1, VENDOR_STR };

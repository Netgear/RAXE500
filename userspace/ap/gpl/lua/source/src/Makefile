...
CFLAGS= -O2 -Wall -DLUA_COMPAT_ALL $(SYSCFLAGS) $(MYCFLAGS) -I../../../readline
LDFLAGS= $(SYSLDFLAGS) $(MYLDFLAGS) -lreadline
LIBS= -lm $(SYSLIBS) $(MYLIBS)

AR= arm-uclibc-linux-2.6.36-ar rcu
...
PLATS= aix ansi bsd freebsd generic linux macosx mingw posix solaris r7000
...
r7000:
	$(MAKE) $(LUA_A) SYSCFLAGS="-DLUA_USE_LINUX" SYSLIBS="-Wl,-E -ldl"

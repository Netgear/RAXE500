...
LIBAV_CONFIGURATION=--prefix=/usr --arch=arm --target-os=linux --cc=arm-buildroot-linux-gnueabi-gcc --enable-cross-compile --disable-static --enable-shared
prefix=/usr
...
SRC_PATH=.
CC_IDENT=gcc 5.3.0 (Buildroot 2016.02)
ARCH=arm
CC=arm-buildroot-linux-gnueabi-gcc
AS=arm-buildroot-linux-gnueabi-gcc
LD=arm-buildroot-linux-gnueabi-gcc
DEPCC=arm-buildroot-linux-gnueabi-gcc
YASM=yasm
YASMDEP=yasm
AR=ar
RANLIB=ranlib
...
VCODEC_TESTS=asv1 asv2 cljr dnxhd_1080i dnxhd_720p dnxhd_720p_10bit dnxhd_720p_rd dv dv50 dv_411 error ffv1 flv h261 h263 h263p huffyuv jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2_422 mpeg2_idct_int mpeg2_ilace mpeg2_ivlc_qprd mpeg2thread mpeg2thread_ilace mpeg4 mpeg4_adap mpeg4_qpel mpeg4_qprd mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 qtrle rc rgb roq rv10 rv20 snow snowll svq1 v210 vref wmv1 wmv2 yuv 

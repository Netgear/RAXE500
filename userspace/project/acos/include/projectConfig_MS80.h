...
#define BACKUP_CFG_HEADER			"<header>MS80-Foxconn<\header>"
#define BACKUP_CFG_PASSWORD_BYTE1   'M'
#define BACKUP_CFG_PASSWORD_BYTE2   'S'
#define BACKUP_CFG_PASSWORD_BYTE3   '8'
...
#define WIFI_BACKHAUL_INTREFACE            "wl2"

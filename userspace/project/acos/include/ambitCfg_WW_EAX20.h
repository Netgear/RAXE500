...
#define AMBIT_HARDWARE_VERSION     "U12H402T00"
#define AMBIT_SOFTWARE_VERSION     "V1.0.0.8"
#define AMBIT_UI_VERSION           "1.0.11"
#define STRING_TBL_VERSION         "1.0.0.8_2.1.46.1"
#define AMBIT_DEVICE_ID            "EAX20"
#define AMBIT_HW_VERSION           "V1"
#define WWW_FOLDER_VERSION         "40208/"

//they will be used in eastforkCgi.c
#define NETGEAR_DEVICE_ID          AMBIT_DEVICE_ID
#define NETGEAR_HARDWARE_VERSION   AMBIT_HW_VERSION

#define AMBIT_PRODUCT_NAME          "EAX20"
#define AMBIT_PRODUCT_ALIAS         "Nighthawk"
#define AMBIT_PRODUCT_DESCRIPTION   "802.11ac Dual Band Gigabit WiFi Mesh Extender EAX20"

#define AMBIT_PRODUCT_DESIGN        "HERO"
//#define AMBIT_PRODUCT_MODEL         "AC1900"
...
//#define DOCUMENT_URL                "http://downloadcenter.netgear.com/" //defined in other place of the file
#define SUCCESS_URL                 "http://www.netgear.com/success/eax20.aspx"

#define UPnP_MODEL_URL              "https://www.netgear.com/home/products/networking/wifi-routers/EAX20.aspx"
...
#define AMBIT_SOAP_VERSION          "3.53"
/****************************************************************************
...
/* EAX20 */
#define ETHERNET_LAN_IF_NAMES       "eth1 eth2 eth3 eth4"      /* This definitions should be by project. For MR60, its only eth1 */
...
#define LAN_IF_NAME_NUM             "eth1.0"
#define LAN1_IF_NAME_NUM             "eth1.0"
#define LAN2_IF_NAME_NUM             "eth2.0"
#define LAN3_IF_NAME_NUM             "eth3.0"
#define LAN4_IF_NAME_NUM             "eth4.0"
#define WLAN_IF_NAME_NUM            "wl0"
#define WLAN_N_IF_NAME_NUM          "wl1"
#define LAN_PHY_NAME_NUM             "eth1"
#define LAN1_PHY_NAME_NUM             "eth1"
#define LAN2_PHY_NAME_NUM             "eth2"
#define LAN3_PHY_NAME_NUM             "eth3"
#define LAN4_PHY_NAME_NUM             "eth4"

#define DPSTA_IF_NAME               "dpsta"
...
#define WLAN_IF_NAME_5G_3           "wl1.2"
...
#define PRODUCT_BOOT_UP_TIME       "140000" //ms, used by cgi, wait after upgrade, reset, ...
...
#if (defined EAX80) //4*4
#define OPMODE_STR_2G_BG            "wlan_mode_54"
#define OPMODE_STR_2G_HT20          "wlan_mode_600"
#define OPMODE_STR_2G_HT40          "wlan_mode_1200"
#define OPMODE_STR_5G_BG            "wlan_mode_54"
#define OPMODE_STR_5G_HT20          "wlan_mode_600"
#define OPMODE_STR_5G_HT40          "wlan_mode_1200"
#define OPMODE_STR_5G_HT80          "wlan_mode_2400"
#define OPMODE_STR_5G_HT160         "wlan_mode_4800"
#else //2*2
#define OPMODE_STR_2G_BG            "wlan_mode_54"
#define OPMODE_STR_2G_HT20          "wlan_mode_289"
#define OPMODE_STR_2G_HT40          "wlan_mode_600"
#define OPMODE_STR_5G_BG            "wlan_mode_54"
#define OPMODE_STR_5G_HT20          "wlan_mode_289"
#define OPMODE_STR_5G_HT40          "wlan_mode_600"
#define OPMODE_STR_5G_HT80          "wlan_mode_1200"
//#define OPMODE_STR_5G_HT160         "wlan_mode_2400"
#endif
...
/* GPIO definitions: -1 means not support */
#define GPIO_POWER_LED_GREEN        22
#define GPIO_POWER_LED_WHITE        8
#define GPIO_POWER_LED_RED          23
#define GPIO_POWER_LED_BLUE         10
#define GPIO_POWER_LED_AMBER        -1
#define GPIO_WAN_LED_GREEN          3
#define GPIO_WAN_LED_WHITE          25
#define GPIO_WAN_LED_RED            15
#define GPIO_WAN_LED_BLUE           24
#define GPIO_WAN_LED_AMBER          -1
#define GPIO_LAN_LED_WHITE          11
#define GPIO_WIFI_2G_LED            7
#define GPIO_WIFI_5G_LED            5
#define GPIO_WIFI_5G_2_LED          -1  /*only for 8500*/
#define GPIO_WIFI_SUMMARY_LED       -1
#define WPS_LED_GPIO                1
#define GPIO_USB1_LED               -1   /* USB3.0 LED. */
#define GPIO_USB2_LED               -1   /* USB2.0 LED. */
#define GPIO_LED_BTN_LED            -1
#define GPIO_WIFI_LNA_LED           -1

#ifdef CONFIG_PRODUCT_ALIAS
#define GPIO_WIFI_GUEST_LED         -1   /*R7900P*/
...
#define GPIO_USB_LED        -1   /* USB1 LED. */
...
#define FS_ZIP_LANG_TBL      "/tmp/string_table.bz2"

...
#define BACKUP_CFG_HEADER			"<header>RAX220-Foxconn<\header>"
...
#define BACKUP_CFG_PASSWORD_BYTE5   '2'
#define BACKUP_CFG_PASSWORD_BYTE6   '0'
#define BACKUP_CFG_PASSWORD_BYTE7   'q'
...
#define FIRMWARE_FILE_MAX_SIZE      192*1024*1024
...
#define WIFI_PUSH_BUTTON_GPIO       10
#define WIFI_PUSH_BUTTON_PRESSED    0

#define RESET_PUSH_BUTTON_GPIO      21
#define RESET_PUSH_BUTTON_PRESSED   0

#define LED_PUSH_BUTTON_GPIO        12
#define LED_PUSH_BUTTON_PRESSED     0
...
#define WIRELESS_6G_HT80_DEFAULT_CHANNEL		"37"
#define WIRELESS_6G_HT160_DEFAULT_CHANNEL		"37"


#define LAN_5_INTERFACE "eth5"
#define GET_LAG1_STATUS     "/sys/class/net/eth3/carrier"
#define GET_LAG2_STATUS     "/sys/class/net/eth4/carrier"

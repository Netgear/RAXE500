...
#define AMBIT_HARDWARE_VERSION     "U12H444T10"
#define AMBIT_SOFTWARE_VERSION     "V1.1.0.4"
#define AMBIT_UI_VERSION           "3.1.45"
#define STRING_TBL_VERSION         "1.1.0.4_2.1.46.1"

#define AMBIT_PRODUCT_NAME          "MS80"
#define AMBIT_PRODUCT_ALIAS         "Nighthawk"
#define AMBIT_PRODUCT_DESCRIPTION   "802.11ac Dual Band Gigabit Wireless Router MS80"
#define UPnP_MODEL_URL              "https://www.netgear.com/home/products/networking/wifi-routers/MS80.aspx"
...
/* MR60 */
#define ETHERNET_LAN_IF_NAMES       "eth1"      /* This definitions should be by project. For MR60, its only eth1 */
...
#define LAN_IF_NAME_IN_BR_NUM       "eth0.0" //lan ifname in br0
...
#define WLAN_BH_IF_NAME_NUM          "wl2"
...
#define WLAN_IF_NAME_2G_3           "wl0.2"
#define WLAN_PHY_NAME_5G            "wl1"
#define WLAN_IF_NAME_5G_1           "wl2"
#define WLAN_IF_NAME_5G_2           "wl1"
#define WLAN_IF_NAME_5G_3           "wl1.3" //guest, why not wl1.2? strange define for MS80
#define WLAN_PHY_NAME_5G2           "wl2"
#define WLAN_IF_NAME_5G2_1          "wl2"
#define WLAN_IF_NAME_5G2_2          "wl2.1"
#define WLAN_IF_NAME_5G2_3          "wl2.2"
...
/* The define is for acos_agent for find the agent */
#define WL_BSSID_AGENT_ID_DIFF   4
#define ETHERNET_AGENT_ID_DIFF   1
#define BR_MAC_AGNET_ID_DIFF     2
...
#ifdef MULTIPLE_SSID
#define WLAN_BSS1_NAME_NUM          "wl0.1"     /* don't query wl0.1 */
...
#define WIRELESS_MODE_2G_HT20                   "300Mbps"
#define WIRELESS_MODE_2G_HT40                   "600Mbps"
#define WIRELESS_MODE_5G_HT20                   "300Mbps"
#define WIRELESS_MODE_5G_HT40                   "600Mbps"
#define WIRELESS_MODE_5G_HT80                   "1200Mbps"
#define WIRELESS_MODE_5G_HT160                  "0Mbps"
#define WIRELESS_SUPPORT_MODE_2G                "54Mbps,300Mbps,600Mbps"
#define WIRELESS_SUPPORT_MODE_5G                "300Mbps,600Mbps,1200Mbps"
...
/*2x2*/
#define PURE_AC_RATE_STR_HT20                    "173M"
#define PURE_AC_RATE_STR_HT40                    "400M"
#define PURE_AC_RATE_STR_HT80                    "866M"
#define PURE_AC_RATE_STR_HT160                   "0M"
#define PURE_AC_RATE_STR_HE20                    "289M"
#define PURE_AC_RATE_STR_HE40                    "600M"
#define PURE_AC_RATE_STR_HE80                    "1200M"
#define PURE_AC_RATE_STR_HE160                   "0M"
...
#define WIRELESS_MODE_5G_HT40                   "600Mbps"
#define WIRELESS_MODE_5G_HT80                   "1200Mbps"
#define WIRELESS_MODE_2G_HE20                   "300Mbps"
#define WIRELESS_MODE_2G_HE40                   "600Mbps"
#define WIRELESS_MODE_5G_HE20                   "300Mbps"
#define WIRELESS_MODE_5G_HE40                   "600Mbps"
#define WIRELESS_MODE_5G_HE80                   "1200Mbps"

#define WIRELESS_SUPPORT_MODE_2G                "54Mbps,300Mbps,600Mbps"
#define WIRELESS_SUPPORT_MODE_5G                "300Mbps,600Mbps,1200Mbps"
#define WIRELESS_SUPPORT_ACMODE_2G              "54Mbps,300Mbps,600Mbps"
/* soap_wlan.c, upnp_asp.c */
...
#define AC_RATE_STR_HT20_5G                    "173M"
#define AC_RATE_STR_HT40_5G                    "400M"
#define AC_RATE_STR_HT80_5G                    "866M"
#define AC_RATE_STR_HE20_5G                    "289M"
...
#define WLMODE_AC_HT20_5G                     WIRELESS_MODE_HT20_2x2
#define WLMODE_AC_HT40_5G                     WIRELESS_MODE_HT40_2x2
#define WLMODE_AC_HT80_5G                     WIRELESS_MODE_HT80_2x2
#define WLMODE_AC_HE20_5G                     WIRELESS_MODE_HE20_2x2
#define WLMODE_AC_HE40_5G                     WIRELESS_MODE_HE40_2x2
#define WLMODE_AC_HE80_5G                     WIRELESS_MODE_HE80_2x2
/* wlgCgi.c, wlgCgi_hostapd.c */

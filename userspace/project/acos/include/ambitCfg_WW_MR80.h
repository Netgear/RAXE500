...
#define AMBIT_HARDWARE_VERSION     "U12H443T00"
#define AMBIT_SOFTWARE_VERSION     "V1.1.0.4"
#define AMBIT_UI_VERSION           "3.1.45"
#define STRING_TBL_VERSION         "1.1.0.4_2.1.46.1"

#define AMBIT_PRODUCT_NAME          "MR80"
#define AMBIT_PRODUCT_ALIAS         "Nighthawk"
#define AMBIT_PRODUCT_DESCRIPTION   "802.11ac Dual Band Gigabit Wireless Router MR80"
#define UPnP_MODEL_URL              "https://www.netgear.com/home/products/networking/wifi-routers/MR80.aspx"
...
#define SOAP_ORBI_AUTHENTICATE_KEYWORD "NETGEAR_Mesh_"
/****************************************************************************
...
/* MR80 */
#define ETHERNET_LAN_IF_NAMES       "eth1"      /* This definitions should be by project. For MR80, its only eth1 */
...
#define WL_BSSID_AGENT_ID_DIFF   3
#define ETHERNET_AGENT_ID_DIFF   0
#define BR_MAC_AGNET_ID_DIFF     1
...
#ifdef MULTIPLE_SSID
#define WLAN_BSS1_NAME_NUM          "wl0.1"     /* foxconn Han edited, 08/29/2019 don't query wl0.1 to prevent device_detect print error print*/
...
#define WIRELESS_SETTINGS_PAGE                  "WLG_wireless2.htm"
...
#define AC_RATE_STR_HT80_5G                    "867M"

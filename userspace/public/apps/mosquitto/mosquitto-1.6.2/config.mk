...
ifeq ($(WITH_TLS),yes)
	...
	CLIENT_CPPFLAGS:=$(CLIENT_CPPFLAGS) -DWITH_TLS -I$(BCM_FSBUILD_DIR)/public/include 
	STATIC_LIB_DEPS:=$(STATIC_LIB_DEPS) -lssl -lcrypto -L$(BCM_FSBUILD_DIR)/public/lib
	CLIENT_LDFLAGS:= $(CLIENT_LDFLAGS) -L$(BCM_FSBUILD_DIR)/public/lib
	CLIENT_LDADD:=${CLIENT_LDADD} -lssl -lcrypto 
	CFLAGS:=$(CFLAGS) -I$(BCM_FSBUILD_DIR)/public/include 

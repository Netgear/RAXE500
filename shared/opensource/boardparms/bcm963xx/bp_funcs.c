...
*              LED that is used when there is a Epon connection failure.
*
...
#if defined(_BCM96858_) || defined(_BCM96846_) || defined(_BCM96856_) || defined(CONFIG_BCM_PON) || defined(_BCM963158_) || defined(CONFIG_BCM963158) || defined(_BCM96878_)
/****************************************************************************
...
int BpInitPhyIntfInfo(void)
{
   ...
   if (!g_pCurrentBp)
    ...
    for( i = 0; i < physIntfTotalCnt; i++ )
        printk("intf %d id %d type %d port num %d, bp start %px\n", 

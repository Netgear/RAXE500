...
static bp_elem_t g_bcm963158sv[] = {
  ...
  MOVED_DT({bp_usExtIntrSDCardDetect,   .u.us = BP_EXT_INTR_0 | BP_EXT_INTR_TYPE_IRQ_BOTH_EDGE | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  ...
  MOVED_DT({bp_usUsbPwrOn1,             .u.us = BP_GPIO_124_AL},)
  MOVED_DT({bp_usUsbPwrFlt1,            .u.us = BP_GPIO_123_AL},)
  MOVED_DT({bp_usUsbPwrOn0,             .u.us = BP_GPIO_122_AL},)
  MOVED_DT({bp_usUsbPwrFlt0,            .u.us = BP_GPIO_121_AL},)
...
static bp_elem_t g_bcm963158dvt_lan[] = {
  ...
  MOVED_DT({  bp_usGpio_Intr,           .u.us = BP_GPIO_41_AL},)
  ...
  MOVED_DT({  bp_usGpio_Intr,           .u.us = BP_GPIO_46_AL},)
...
static bp_elem_t g_bcm963158ref1[] = {
  ...
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_20_AL},)
...
static bp_elem_t g_bcm963158ref2[] = {
  ...
  MOVED_DT({  bp_usGpio_Intr,           .u.us = BP_GPIO_89_AL},)
  MOVED_DT({  bp_usButtonAction,        .u.us = BP_BTN_ACTION_PRINT | BP_BTN_TRIG_PRESS },)
  MOVED_DT({    bp_ulButtonActionParm,  .u.ptr = (void*)"Button Press -- Hold for 5s to do restore to default" },)
  MOVED_DT({  bp_usButtonAction,        .u.us = BP_BTN_ACTION_RESET | BP_BTN_TRIG_RELEASE | BP_BTN_TRIG_0S  },)
  MOVED_DT({  bp_usButtonAction,        .u.us = BP_BTN_ACTION_RESTORE_DEFAULTS | BP_BTN_TRIG_HOLD | BP_BTN_TRIG_5S},)
#endif
  MOVED_DT({bp_usExtIntrSDCardDetect,   .u.us = BP_EXT_INTR_2 | BP_EXT_INTR_TYPE_IRQ_BOTH_EDGE | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_90_AL},)
  ...
  {bp_usIntfMgmtBusNum,        .u.us = 1},
  MOVED_DT({bp_usExtIntrOpticalModulePresence, .u.us = BP_EXT_INTR_3 | BP_EXT_INTR_TYPE_IRQ_BOTH_EDGE | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_17_AL},)
...
//secondary definitions for AfeIds
  ...
  /* keep i2c and pmd reset in bp for detecting pmd type using
   * legacy i2c/spf device driver. Will remove all these parameter 
   * after migrate all the pon drivers to dts
   */
  {bp_usIntfMgmtType,          .u.us = BP_INTF_MGMT_TYPE_I2C},
  {bp_usIntfMgmtBusNum,        .u.us = 0},
  {bp_usSfpSigDetect,          .u.us = BP_GPIO_10_AH },
  {bp_usGpioPmdReset,          .u.us = BP_GPIO_5_AL},  
  MOVED_DT({bp_usRogueOnuEn,            .u.us = BP_GPIO_40_AH},)
  //{bp_usPmdMACEwakeEn,         .u.us = BP_GPIO_3_AH}, /* has a flaw with this pinmux */
  MOVED_DT({bp_usExtIntrPmdAlarm,       .u.us = BP_EXT_INTR_3 | BP_EXT_INTR_TYPE_IRQ_HIGH_LEVEL | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_40_AH},)
...
//secondary definitions for AfeIds
  ...
  {bp_usGpioPmdReset,          .u.us = BP_GPIO_5_AL},  
  MOVED_DT({bp_usRogueOnuEn,            .u.us = BP_GPIO_40_AH},)
  MOVED_DT({bp_usPmdMACEwakeEn,         .u.us = BP_GPIO_39_AH},)
  MOVED_DT({bp_usExtIntrPmdAlarm,       .u.us = BP_EXT_INTR_3 | BP_EXT_INTR_TYPE_IRQ_HIGH_LEVEL | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_40_AH},)
  MOVED_DT({bp_pmdFunc,                 .u.us = BP_PMD_APD_TYPE_BOOST | BP_PMD_APD_REG_DISABLED},)
  {bp_usIntfEnd},
...
static bp_elem_t g_bcm963158x_2p5glan[] = {
  ...
  {bp_usGpioPmdReset,          .u.us = BP_GPIO_5_AL},
  MOVED_DT({bp_usRogueOnuEn,            .u.us = BP_GPIO_40_AH},)
  MOVED_DT({bp_usPmdMACEwakeEn,         .u.us = BP_GPIO_33_AH},)
  MOVED_DT({bp_usExtIntrPmdAlarm,       .u.us = BP_EXT_INTR_3 | BP_EXT_INTR_TYPE_IRQ_HIGH_LEVEL | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_40_AH},)
  MOVED_DT({bp_pmdFunc,                 .u.us = BP_PMD_APD_REG_DISABLED},)
  {bp_usIntfEnd},
  {bp_usIntfId,                .u.us = 4},
  {bp_usIntfType,              .u.us = BP_INTF_TYPE_I2C},
  {bp_usPortNum,               .u.us = 0},
...
static bp_elem_t g_bcm963158ref3d_p200[] = {
  ...
  {bp_usGpioPmdReset,          .u.us = BP_GPIO_5_AL},
  MOVED_DT({bp_usRogueOnuEn,            .u.us = BP_GPIO_40_AH},)
  MOVED_DT({bp_usPmdMACEwakeEn,         .u.us = BP_GPIO_41_AH},)  /* update from gpio 39 to 41 in P200 */
  MOVED_DT({bp_usExtIntrPmdAlarm,       .u.us = BP_EXT_INTR_3 | BP_EXT_INTR_TYPE_IRQ_HIGH_LEVEL | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_40_AH},)
  MOVED_DT({bp_pmdFunc,                 .u.us = BP_PMD_APD_TYPE_BOOST | BP_PMD_APD_REG_DISABLED},)
  {bp_usIntfEnd},
...
static bp_elem_t g_bcm963153ref4d_xg[] = {
  ...
  {bp_usGpioPmdReset,          .u.us = BP_GPIO_5_AL},  
  MOVED_DT({bp_usRogueOnuEn,            .u.us = BP_GPIO_40_AH},)
  MOVED_DT({bp_usPmdMACEwakeEn,         .u.us = BP_GPIO_41_AH},)
...
static bp_elem_t g_bcm963158t[] = {
  {bp_cpBoardId,               .u.cp = "963158T"},
  {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_NAND},
  {bp_ulInterfaceEnable,       .u.ul = BP_PINMUX_FNTYPE_EMMC},
  ...
  {bp_usIntfType,              .u.us = BP_INTF_TYPE_xPON},
  {bp_usPortNum,               .u.us = 0},
  {bp_usGpioLedWanLink,        .u.us = BP_GPIO_5_AH},  /* For GPON ranging software led */
  {bp_usNetLed1,               .u.us = BP_GPIO_14_AH},
  {bp_ulNetLedLink,            .u.ul = BP_NET_LED_SPEED_1G|BP_NET_LED_SPEED_100},
  {bp_ulNetLedActivity,        .u.ul = BP_NET_LED_SPEED_1G|BP_NET_LED_SPEED_100},
  {bp_usNetLed2,               .u.us = BP_GPIO_15_AH},
  {bp_ulNetLedLink,            .u.ul = BP_NET_LED_SPEED_2500|BP_NET_LED_SPEED_10G},
  {bp_ulNetLedActivity,        .u.ul = BP_NET_LED_SPEED_2500|BP_NET_LED_SPEED_10G},
  MOVED_DT({bp_usExtIntrOpticalModulePresence, .u.us = BP_EXT_INTR_3 | BP_EXT_INTR_TYPE_IRQ_BOTH_EDGE | BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE},)
  MOVED_DT({bp_usGpio_Intr,             .u.us = BP_GPIO_9_AL},)
...
bp_elem_t * g_BoardParms[] = {g_bcm963158sv, g_bcm963158dvt, g_bcm963158ref1, g_bcm963158ref2, g_bcm963158ref3, g_bcm963158dvt_lan, g_bcm963158ref3_p20x, g_bcm963158x_2p5gwan, g_bcm963158ref1_10gae, g_bcm963158ref1_10gag, g_bcm963158ref1_p20x, g_bcm963158dvt_xgae, g_bcm963158x_2p5glan, g_bcm963158ref3d, g_bcm963158ref3d_p200, g_bcm963158ref2_2p5glan, g_bcm963158ref3_2p5glan, g_bcm963158dvt_p200, g_bcm963158ref1d, g_bcm963158dvt_p200_xgae, g_bcm963153ref4d, g_bcm963153ref4d_xg, g_bcm963153ref4d_2p5glan, g_bcm963158ref2d, g_bcm963158ref2d_2p5glan, g_bcm963158ref1d_10gae, g_bcm963158ref1d_10gag, g_bcm963158x_54991, g_bcm963158x_84881, g_bcm963153ref4d_no2p5_phy, g_bcm963158ref1_2p5w, g_bcm963158t, 0};

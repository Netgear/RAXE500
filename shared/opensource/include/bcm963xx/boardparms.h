...
#define BP_AFE_FE_REV_6303_146__REV_12_3_60	(3 << 8)
...
#if defined(CONFIG_BCM963178) || defined(_BCM963178_) || defined(CONFIG_BCM94912) || defined(_BCM94912_)
...
#define BP_DDR_SPEED_1200_18_18_18	19	/* DDR4-2400U */
#define BP_DDR_SPEED_1333_19_19_19	20	/* DDR4-2666V */
#define BP_DDR_SPEED_1600_22_22_22	21	/* DDR4-3200AA */
#define BP_DDR_SPEED_1600_24_24_24	22	/* DDR4-3200AC */
...
#define BP_BTN_ACTION_RESTORE_DEFAULTS      (2 << BP_BTN_ACTION_SHIFT)
#define BP_BTN_ACTION_RESET                 (3 << BP_BTN_ACTION_SHIFT)
#define BP_BTN_ACTION_PRINT                 (4 << BP_BTN_ACTION_SHIFT)
#define BP_BTN_ACTION_WLAN_DOWN             (5 << BP_BTN_ACTION_SHIFT)
...
// !!!!! Warning: Using boardparams functionality deprecated and should not be used anymore. Consider using the Device tree instead !!!!!

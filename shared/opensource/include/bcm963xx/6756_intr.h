...
/*sysport 54:59*/
#define INTERRUPT_SYSPORT0_0        (SPI_TABLE_OFFSET + 54)
#define INTERRUPT_SYSPORT0_1        (SPI_TABLE_OFFSET + 55)
#define INTERRUPT_SYSPORT0_2        (SPI_TABLE_OFFSET + 56)
#define INTERRUPT_SYSPORT0_3        (SPI_TABLE_OFFSET + 57)
#define INTERRUPT_SYSPORT0_4        (SPI_TABLE_OFFSET + 58)
#define INTERRUPT_SYSPORT0_5        (SPI_TABLE_OFFSET + 59)
...
#define INTERRUPT_ID_SYSPORT0_5           _2MAP(INTERRUPT_SYSPORT0_5)

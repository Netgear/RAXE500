...
static int bcm_common_led_linux_init(void)
{
    ...
    if ((np = of_find_compatible_node(NULL, NULL, "brcm,bca-leds-ctrl")) || (np = of_find_compatible_node(NULL, NULL, "brcm,bca-cleds-ctrl")))
    {
    ...
    if(CHIP_FAMILY_ID_HEX == 0x4912 || CHIP_FAMILY_ID_HEX == 0x63146)
        return 0;

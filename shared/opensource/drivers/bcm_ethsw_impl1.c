...
extern spinlock_t mdio_access;
    ...
    defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912) || !defined(__KERNEL__)
...
void bcm_ethsw_phy_write_reg(int phy_id, int reg, uint16 data)
{
    ...
    defined(_BCM963146_) || defined(CONFIG_BCM963146)  || defined(_BCM94912_) || defined(CONFIG_BCM94912) || \
...
static void extsw_register_save_restore(int save)
{
    ...
    defined(CONFIG_BCM94912)  || defined(_BCM94912_)  || \
...
#if !defined(CONFIG_BCM963146) && !defined(CONFIG_BCM94912)  //TODO146: for simulation don't init led
    bcm_ethsw_led_init();
#endif

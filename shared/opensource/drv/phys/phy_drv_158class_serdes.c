...
{
    return _dsl_xgae_speed_set(phy_dev, speed, duplex, 1); /* Needs to force for light detect */
}
...
//reg_model.wan_top_reg_blk.wan_top_misc_2_reg
    ...
    */
    ...
    if (phy_serdes->inter_phy_types == INTER_PHY_TYPE_SGMII) {
...
{
    {
        ...
        .bp_intf_type = BP_INTF_TYPE_xPON,
...
static int phy_drv_serdes_158class_init(phy_dev_t *phy_dev)
{
    phy_serdes_t *phy_serdes;
    static int core_num = 0;

    phy_serdes = phy_dev->priv = &serdes_158class[core_num];
    phy_serdes->core_num = core_num;
    core_num++;
...
static int dsl_xgae_priv_fun(phy_dev_t *phy_dev, int op_code, va_list ap)
{
...
{
    .init = phy_drv_serdes_158class_init,
    .phy_type = PHY_TYPE_158CLASS_SERDES,
    .read_status = phy_dsl_serdes_read_status,
    //.apd_get = dsl_xgae_power_mode_get,
    //.apd_set = dsl_xgae_power_mode_set,

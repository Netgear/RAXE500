...
static inline int phy_drv_serdes146_get_mdio_addr(int core_num)
{
    return phy_drv_serdes146_get_phy_dev(core_num)->addr;
}
static inline phy_serdes_t *phy_drv_serdes146_get_serdes(int core_num)
{
    return (phy_serdes_t *)(phy_drv_serdes146_get_phy_dev(core_num)->priv);
}
#define HOST_MDIO_PHY_ADDR(core_num) phy_drv_serdes146_get_mdio_addr(core_num)

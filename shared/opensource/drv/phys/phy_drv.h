...
#define INTER_PHY_TYPE_MULTI_SPEED_AN_MASK_M \
    (INTER_PHY_TYPE_SGMII_M | INTER_PHY_TYPE_USXGMII_M | INTER_PHY_TYPE_MLTI_SPEED_BASE_X_AN_M )
/*
...
/*
    ...
    o Top Letters before digits: S: SGMII; U: USXGMII; US: USXGMII and SGMII
                            M: MultiSpeedAN, G: SingleSpeedAN
...
#define INTER_PHY_TYPES_MUS1KR2KXR_M ( \
...
#define INTER_PHY_TYPES_MUS1KR2KXR5KXR_M ( \
    INTER_PHY_TYPES_MUS1KR2KXR_M | INTER_PHY_TYPE_5000BASE_X_M | \
    INTER_PHY_TYPE_5GBASE_X_M | INTER_PHY_TYPE_5GBASE_R_M)

#define INTER_PHY_TYPES_MUS1KR2KXR5KXR10R_M ( \
    INTER_PHY_TYPES_MUS1KR2KXR5KXR_M |INTER_PHY_TYPE_10GBASE_R_M)
...
static inline int get_inter_phy_supported_speed_caps(int inter_phy_types, uint32_t *supported_speed_caps)
{
    ...
    *supported_speed_caps = 0;
    ...
    /* Remove SGMII/USXGMII if there are fixed speeds */
    if (inter_phy_types & ~(INTER_PHY_TYPE_SGMII_M | INTER_PHY_TYPE_USXGMII_M | INTER_PHY_TYPE_MLTI_SPEED_BASE_X_AN_M))
        inter_phy_types &= ~(INTER_PHY_TYPE_SGMII_M | INTER_PHY_TYPE_USXGMII_M | INTER_PHY_TYPE_MLTI_SPEED_BASE_X_AN_M);
...
#define phy_speed_to_caps phy_speed_to_cap  /* For QEMU old code includes */

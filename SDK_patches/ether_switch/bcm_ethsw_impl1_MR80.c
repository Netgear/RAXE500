...
void mr80_ethsw_wan_loopback(void)
{
    printk("Set MR80 WAN port loopback to avoid tx/rx invlaid packets\n");
    sw_wreg(PAGE_INTERNAL_PHY_MII, REG_G_MIICTL, G_MIICTL_LOOPBACK, 2);
}

...
#define netdev_wlan_set_dwds_ap(wlif)           ((wlif) ? ((wlif)->flags = FLAG_DWDS_AP) : BCM_REFERENCE(wlif))
#endif
#ifndef netdev_wlan_unset_dwds_ap
#define netdev_wlan_unset_dwds_ap(wlif)         ((wlif) ? ((wlif)->flags &= ~FLAG_DWDS_AP) : BCM_REFERENCE(wlif))
#endif
#ifndef is_netdev_wlan_dwds_ap
#define is_netdev_wlan_dwds_ap(wlif)            ((wlif) ? ((wlif)->flags & FLAG_DWDS_AP) : false)
#endif

#ifndef netdev_wlan_set_dwds_client
#define netdev_wlan_set_dwds_client(wlif)       ((wlif) ? ((wlif)->flags = FLAG_DWDS_CLIENT) : BCM_REFERENCE(wlif))
#endif
#ifndef netdev_wlan_unset_dwds_client
#define netdev_wlan_unset_dwds_client(wlif)     ((wlif) ? ((wlif)->flags &= ~FLAG_DWDS_CLIENT) : BCM_REFERENCE(wlif))
#endif
#ifndef is_netdev_wlan_dwds_client
#define is_netdev_wlan_dwds_client(wlif)        ((wlif) ? ((wlif)->flags & FLAG_DWDS_CLIENT) : false)
#endif

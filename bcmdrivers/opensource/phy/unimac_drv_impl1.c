...
#define     UNIMAC_VER3  3  /* for 63146 & 4912 devices */
...
{
    int ret;
    uintptr_t unimac_conf_base2;
    uintptr_t unimac_mib_base2;
    uintptr_t unimac_top_base2;
    ...
    conf_offset = (uint32_t)unimac_conf_base2 - (uint32_t)unimac_conf_base;
    mib_offset  = (uint32_t)unimac_mib_base2  - (uint32_t)unimac_mib_base;
    top_offset  = (uint32_t)unimac_top_base2  - (uint32_t)unimac_top_base;
...
/*                                                                           */
/*****************************************************************************/
#if !(defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM96878) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912))
#include "clk_rst.h"
#endif
...
void mac_hwapi_set_configuration(rdpa_emac emacNum,rdpa_emac_cfg_t *emac_cfg)
{
...
#if defined(CONFIG_BCM963146)
    {
        ...
        READ_32(address,val);
        if (emac_cfg->rate ==  UNIMAC_SPEED_2500 || emac_cfg->rate ==  UNIMAC_SPEED_5000)
...
#if defined(CONFIG_BCM94908) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
...
/*                                                                            */
/******************************************************************************/
#if defined(CONFIG_BCM947622) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)

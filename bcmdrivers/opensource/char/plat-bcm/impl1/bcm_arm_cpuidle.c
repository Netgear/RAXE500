...
#include "board.h"
    ...
    defined(CONFIG_BCM96756) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
...
void BcmPwrMngtSetDRAMSelfRefresh(unsigned int enable)
{
	...
	if (enable) {
		...
		MEMC->glb.auto_self_refresh |= MEMC_DDR_AUTO_SELFREFRESH_EN;
#else
...
{
#if defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
	uint32_t reg = MEMC->glb.auto_self_refresh;
#else
	uint32_t reg = MEMC->CHN_TIM_AUTO_SELF_REFRESH;
#endif
	uint32_t thres_us = (reg & MEMC_DDR_AUTO_SR_IDLE_CNT_MASK) / MEMC_CLK_INMHZ;
...
#if defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
	MEMC->glb.auto_self_refresh = reg;
#else
...
static int __init bcm_arm_cpuidle_init(void)
{
 ...
 #error BCM_CPUIDLE_CLK_DIVIDER not support on this chip
...
#if defined(CONFIG_BCM96858) || defined(CONFIG_BCM94908) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM963138) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
...
#endif
#if defined(CONFIG_BCM963178) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
	...
	// automatically enters self-refresh, if enabled;
	// and enable MEMC Slow Clock when DDR Self-Refresh is activated
#if defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
	MEMC->glb.auto_self_refresh &= ~(MEMC_DDR_AUTO_SR_IDLE_CNT_MASK);
	MEMC->glb.auto_self_refresh |= ((DEFAULT_DDR_AUTOSR_THRSH_US * MEMC_CLK_INMHZ) &
			MEMC_DDR_AUTO_SR_IDLE_CNT_MASK);

        MEMC->glb.gcfg |= MEMC_GLB_GCFG_SREF_SLOW_CLK_MASK;
#else
...
#endif // #if defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
...
#endif
#endif // #if defined(CONFIG_BCM_DDR_SELF_REFRESH_PWRSAVE)

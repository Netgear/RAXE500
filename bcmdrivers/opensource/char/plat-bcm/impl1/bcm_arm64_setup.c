...
#if defined(CONFIG_BCM963158) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
...
#if defined(CONFIG_BCM_GLB_COHERENCY) && (defined(CONFIG_BCM963158) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM96858) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM94912))
    cci_coherent_enable();
#endif

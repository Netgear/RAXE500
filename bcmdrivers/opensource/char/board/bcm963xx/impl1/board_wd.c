...
int bcm_suspend_watchdog() 
{
    ...
    {
#if defined(CONFIG_BCM96858) || defined (CONFIG_BCM963158) || defined(CONFIG_BCM96846) || \
    defined(CONFIG_BCM947622) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM96878) || \
...
#if defined(CONFIG_BCM96858) || defined (CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96878) || defined(CONFIG_BCM96855)
    WDTIMER0->WatchDogCtl = 0xEE00;
    WDTIMER0->WatchDogCtl = 0x00EE;
...
void start_watchdog(unsigned int timer, unsigned int reset) 
{
    ...
    if (!reset && !watchdog_data.enabled)
    {
      ...
      defined(CONFIG_BCM96856) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM963178) || \

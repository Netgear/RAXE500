...
#if defined(CONFIG_BCM963158) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912)
#include "pmc_dgasp.h"
#endif
...
static int isDGActiveOnBoot(void)
{
    ...
    dg_active = 0;
#elif defined(CONFIG_BCM963158) || defined(CONFIG_BCM963146) || defined(CONFIG_BCM94912) // ag941316?? is this correct
...
void __init kerSysInitDyingGaspHandler( void )
{
    ...
    pmc_dgasp_init();
#endif
#elif defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM96878) || \
      defined(CONFIG_BCM94912) || defined(CONFIG_BCM94908)
#if defined(CONFIG_BCM947622) || defined(CONFIG_BCM96855) ||  defined(CONFIG_BCM96756)

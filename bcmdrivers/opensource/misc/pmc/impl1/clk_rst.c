...
{
#if IS_BCMCHIP(63178) || IS_BCMCHIP(63146) || IS_BCMCHIP(4912)
	int ret;
...
#if defined(CONFIG_BCM963178) || defined(CONFIG_BCM963146) ||  defined(CONFIG_BCM94912)
    set_vreg_clk();

...
#if defined(CONFIG_MULTI_WAN_SUPPORT) && !defined(BCM_PON_XRDP) && !defined(BCM4912)
#if !defined(BCM63146)
...
void rdd_fpm_pool_number_mapping_cfg(uint16_t fpm_base_token_size)
{
    ...
    case FPM_BUF_SIZE_320:
        g_fpm_hw_cfg.fpm_token_shift = 8;
        g_fpm_hw_cfg.fpm_token_add_shift = 6;         /* multiply 320=10*2^5 */
        g_fpm_hw_cfg.fpm_token_inv_mant = 0xCCCD;
        g_fpm_hw_cfg.fpm_token_inv_exp = 24;          /* divide by 320 */
        break;

    case FPM_BUF_SIZE_640:
        g_fpm_hw_cfg.fpm_token_shift = 9;
        g_fpm_hw_cfg.fpm_token_add_shift = 7;         /* multiply 640=10*2^6 */
        g_fpm_hw_cfg.fpm_token_inv_mant = 0xCCCD;
        g_fpm_hw_cfg.fpm_token_inv_exp = 25;          /* divide by 640 */
        break;

    case FPM_BUF_SIZE_1280:
        g_fpm_hw_cfg.fpm_token_shift = 10;
        g_fpm_hw_cfg.fpm_token_add_shift = 8;         /* multiply 1280=10*2^7 */
        g_fpm_hw_cfg.fpm_token_inv_mant = 0xCCCD;        
        g_fpm_hw_cfg.fpm_token_inv_exp = 26;          /* divide by 1280 */
        break;

    case FPM_BUF_SIZE_2560:
        g_fpm_hw_cfg.fpm_token_shift = 11;
        g_fpm_hw_cfg.fpm_token_add_shift = 9;         /* multiply 2560=10*2^8 */
        g_fpm_hw_cfg.fpm_token_inv_mant = 0xCCCD;     
        g_fpm_hw_cfg.fpm_token_inv_exp = 27;          /* divide by 2560 */
        break;

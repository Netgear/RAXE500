...
#define runner_b_start_task_timer_scheduler_set		(0x34BC)
#define runner_b_timer_scheduler_set		(0x34BC)
...
#define runner_b_start_task_policer_budget_allocator_1st_wakeup_request		(0x3A08)
#define runner_b_policer_budget_allocator_1st_wakeup_request		(0x3A08)
...
#define runner_b_start_task_timer_7_1st_wakeup_request		(0x36C4)
#define runner_b_timer_7_1st_wakeup_request		(0x36C4)
#define runner_b_start_task_free_skb_index_wakeup_request		(0x3650)
#define runner_b_free_skb_index_wakeup_request		(0x3650)
...
#define runner_b_spdsvc_timer_wakeup_request		(0x3428)
#define runner_b_cpu_rx_meter_budget_allocate		(0x353C)
#define runner_b_upstream_rate_limiter_budget_allocate		(0x3588)
#define runner_b_schedule_free_skb_index		(0x3634)
#define runner_b_pps_rate_limiter_timer_wakeup_request		(0x3728)

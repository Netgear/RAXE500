...
static DUMP_RUNNERREG_STRUCT SERVICE_QUEUES_CODEL_DROP_DESCRIPTOR =
{
	12,
	{
		{ dump_RDD_CODEL_DROP_DESCRIPTOR, 0x2710 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_GLOBAL_CFG =
{
	16,
	{
		{ dump_RDD_FPM_GLOBAL_CFG, 0x2730 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DEBUG_PRINT_TABLE =
{
	16,
	{
		{ dump_RDD_DEBUG_PRINT_INFO, 0x2750 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
static DUMP_RUNNERREG_STRUCT GRE_PRV_DST_IP_LKP_TABLE_1 =
{
	4,
	{
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_INTERRUPT_COALESCING_TABLE_1 =
{
	16,
	{
		{ dump_RDD_CPU_INTERRUPT_COALESCING_ENTRY, 0x2310 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT UDPSPDTEST_STREAM_RX_STAT_TABLE_1 =
{
	48,
	{
		{ dump_RDD_UDPSPDTEST_STREAM_RX_STAT, 0x2c00 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CONFIGURATION_TABLE_1 =
{
	12,
	{
		{ dump_RDD_HW_IPTV_CONFIGURATION, 0x2cb0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GLOBAL_PBIT_TO_DSCP_TABLE_1 =
{
	9,
	{
		{ dump_RDD_PBIT_TO_DSCP_ENTRY, 0x2cf0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT RX_MIRRORING_CONFIGURATION_1 =
{
	2,
	{
		{ dump_RDD_MIRRORING_DESCRIPTOR, 0x2cfa },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BCM_SPDSVC_STREAM_RX_TS_TABLE_1 =
{
	12,
	{
		{ dump_RDD_SPDSVC_RX_TS_STAT, 0x2d20 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_REDIRECT_MODE_1 =
{
	1,
	{
		{ dump_RDD_CPU_REDIRECT_MODE_ENTRY, 0x2d2d },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT SYSTEM_CONFIGURATION_1 =
{
	5,
	{
		{ dump_RDD_SYSTEM_CONFIGURATION_ENTRY, 0x2df8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CLASSIFICATION_CFG_TABLE_1 =
{
	1,
	{
		{ dump_RDD_IPTV_CLASSIFICATION_CFG_ENTRY, 0x2dfd },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_PACKET_BASED_MAPPING_1 =
{
	4,
	{
		{ dump_RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY, 0x2ef0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_RING_INTERRUPT_COUNTER_TABLE_1 =
{
	8,
	{
		{ dump_RDD_CPU_RING_INTERRUPT_COUNTER_ENTRY, 0x2ef8 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TUNNELS_PARSING_CFG_1 =
{
	8,
	{
		{ dump_RDD_TUNNELS_PARSING_CFG, 0x2f30 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_DDR_CTX_TABLE_ADDRESS_1 =
{
	8,
	{
		{ dump_RDD_IPTV_DDR_CTX_TABLE_ADDRESS, 0x2f50 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT TUNNEL_HEADER_PSRAM_BUFFER_1 =
{
	4,
	{
		{ dump_RDD_TUNNEL_HEADER_PSRAM_BUFFER, 0x2f60 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GENERAL_QUEUE_DYNAMIC_MNG_TABLE_2 =
{
	8,
	{
		{ dump_RDD_QUEUE_DYNAMIC_MNG_ENTRY, 0x2238 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RECYCLE_INTERRUPT_COALESCING_TABLE_2 =
{
	16,
	{
		{ dump_RDD_CPU_INTERRUPT_COALESCING_ENTRY, 0x2770 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CONFIGURATION_TABLE_2 =
{
	12,
	{
		{ dump_RDD_HW_IPTV_CONFIGURATION, 0x2d20 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_REDIRECT_MODE_2 =
{
	1,
	{
		{ dump_RDD_CPU_REDIRECT_MODE_ENTRY, 0x2d3f },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT GLOBAL_PBIT_TO_DSCP_TABLE_2 =
{
	9,
	{
		{ dump_RDD_PBIT_TO_DSCP_ENTRY, 0x2d60 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT IPTV_CLASSIFICATION_CFG_TABLE_2 =
{
	1,
	{
		{ dump_RDD_IPTV_CLASSIFICATION_CFG_ENTRY, 0x2d6a },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT FPM_GLOBAL_CFG_2 =
{
	16,
	{
		{ dump_RDD_FPM_GLOBAL_CFG, 0x2d70 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_PACKET_BASED_MAPPING_2 =
{
	4,
	{
		{ dump_RDD_INGRESS_PACKET_BASED_MAPPING_ENTRY, 0x2e30 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT MULTICAST_KEY_MASK_2 =
{
	4,
	{
		{ dump_RDD_MULTICAST_KEY_MASK_ENTRY, 0x2ea0 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT INGRESS_FILTER_CFG_2 =
{
	2,
	{
		{ dump_RDD_INGRESS_FILTER_CFG, 0x2eb8 },
		{ 0, 0 },
	}
};
#endif
...
#endif
#if defined BCM6846
	{ "GRE_PRV_DST_IP_LKP_TABLE", 1, CORE_1_INDEX, &GRE_PRV_DST_IP_LKP_TABLE_1, 16, 1, 1 },
#endif
#if defined BCM6846

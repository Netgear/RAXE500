...
#define image_0_start_task_cpu_tx_wakeup_request        (0x2d0)
#define image_0_cpu_tx_wakeup_request        (0x2d0)
...
#define image_0_start_task_cpu_tx_wakeup_request        (0xb4)
#define image_0_cpu_tx_wakeup_request        (0xb4)

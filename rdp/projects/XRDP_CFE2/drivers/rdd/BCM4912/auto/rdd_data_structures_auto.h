...
} __attribute__((aligned(1))) BYTE_1_STRUCT;
...
} __attribute__((aligned(8))) PARSE_STRUCT;

#define RDD_PARSE_SUMMARY_READ_G(r, g, idx, i)            GROUP_MREAD_I_8(g, idx*sizeof(PARSE_STRUCT), i, r)
#define RDD_PARSE_SUMMARY_WRITE_G(v, g, idx, i)           GROUP_MWRITE_I_8(g, idx*sizeof(PARSE_STRUCT), i, v)
#define RDD_PARSE_SUMMARY_READ(r, p, i)                   MREAD_I_8((uint8_t *)p, i, r)
#define RDD_PARSE_SUMMARY_WRITE(v, p, i)                  MWRITE_I_8((uint8_t *)p, i, v)
#define RDD_PARSE_RESULTS_READ_G(r, g, idx, i)            GROUP_MREAD_I_8(g, idx*sizeof(PARSE_STRUCT) + 4, i, r)
#define RDD_PARSE_RESULTS_WRITE_G(v, g, idx, i)           GROUP_MWRITE_I_8(g, idx*sizeof(PARSE_STRUCT) + 4, i, v)
...
#define RDD_PARSE_L2_LKP_ENTRY_READ_G(r, g, idx, i)       GROUP_MREAD_I_8(g, idx*sizeof(PARSE_STRUCT) + 32, i, r)
#define RDD_PARSE_L2_LKP_ENTRY_WRITE_G(v, g, idx, i)      GROUP_MWRITE_I_8(g, idx*sizeof(PARSE_STRUCT) + 32, i, v)
...
#define RDD_PARSE_L3_LKP_ENTRY_READ_G(r, g, idx, i)       GROUP_MREAD_I_8(g, idx*sizeof(PARSE_STRUCT) + 48, i, r)
#define RDD_PARSE_L3_LKP_ENTRY_WRITE_G(v, g, idx, i)      GROUP_MWRITE_I_8(g, idx*sizeof(PARSE_STRUCT) + 48, i, v)
...
#define RDD_PARSE_IC_LKP_ENTRY_READ_G(r, g, idx, i)       GROUP_MREAD_I_8(g, idx*sizeof(PARSE_STRUCT) + 64, i, r)
#define RDD_PARSE_IC_LKP_ENTRY_WRITE_G(v, g, idx, i)      GROUP_MWRITE_I_8(g, idx*sizeof(PARSE_STRUCT) + 64, i, v)
...
#define RDD_PARSER_RESULTS_L4_PROTOCOL_READ_G(r, g, idx)                GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 4, 4, r) /*defined by rdd_parser_l4_protocol enumeration*/
#define RDD_PARSER_RESULTS_L4_PROTOCOL_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 4, 4, v) /*defined by rdd_parser_l4_protocol enumeration*/
...
#define RDD_PARSER_RESULTS_V6_AH_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 3, 1, r)
#define RDD_PARSER_RESULTS_V6_AH_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 3, 1, v)
...
#define RDD_PARSER_RESULTS_V6_DEST_OPT_READ_G(r, g, idx)                GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 2, 1, r)
#define RDD_PARSER_RESULTS_V6_DEST_OPT_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 2, 1, v)
...
#define RDD_PARSER_RESULTS_V6_ROUTE_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 1, 1, r)
#define RDD_PARSER_RESULTS_V6_ROUTE_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 1, 1, v)
...
#define RDD_PARSER_RESULTS_V6_HOP_READ_G(r, g, idx)                     GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 0, 1, r)
#define RDD_PARSER_RESULTS_V6_HOP_WRITE_G(v, g, idx)                    GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT), 0, 1, v)
...
#define RDD_PARSER_RESULTS_TCP_FLAGS_READ_G(r, g, idx)                  GROUP_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 1, r)
#define RDD_PARSER_RESULTS_TCP_FLAGS_WRITE_G(v, g, idx)                 GROUP_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 1, v)
...
#define RDD_PARSER_RESULTS_LAYER3_OFFSET_READ_G(r, g, idx)              GROUP_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 2, r)
#define RDD_PARSER_RESULTS_LAYER3_OFFSET_WRITE_G(v, g, idx)             GROUP_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 2, v)
...
#define RDD_PARSER_RESULTS_LAYER4_OFFSET_READ_G(r, g, idx)              GROUP_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 3, r)
#define RDD_PARSER_RESULTS_LAYER4_OFFSET_WRITE_G(v, g, idx)             GROUP_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 3, v)
...
#define RDD_PARSER_RESULTS_OUTER_VLAN_READ_G(r, g, idx)                 GROUP_MREAD_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 4, r)
#define RDD_PARSER_RESULTS_OUTER_VLAN_WRITE_G(v, g, idx)                GROUP_MWRITE_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 4, v)
...
#define RDD_PARSER_RESULTS_MAC_DA1_2_READ_G(r, g, idx)                  GROUP_MREAD_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 6, r)
#define RDD_PARSER_RESULTS_MAC_DA1_2_WRITE_G(v, g, idx)                 GROUP_MWRITE_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 6, v)
...
#define RDD_PARSER_RESULTS_MAC_DA3_6_READ_G(r, g, idx)                  GROUP_MREAD_32(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 8, r)
#define RDD_PARSER_RESULTS_MAC_DA3_6_WRITE_G(v, g, idx)                 GROUP_MWRITE_32(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 8, v)
...
#define RDD_PARSER_RESULTS_INNER_VLAN_READ_G(r, g, idx)                 GROUP_MREAD_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 12, r)
#define RDD_PARSER_RESULTS_INNER_VLAN_WRITE_G(v, g, idx)                GROUP_MWRITE_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 12, v)
...
#define RDD_PARSER_RESULTS_MAC_SA1_2_READ_G(r, g, idx)                  GROUP_MREAD_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 14, r)
#define RDD_PARSER_RESULTS_MAC_SA1_2_WRITE_G(v, g, idx)                 GROUP_MWRITE_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 14, v)
...
#define RDD_PARSER_RESULTS_MAC_SA3_6_READ_G(r, g, idx)                  GROUP_MREAD_32(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 16, r)
#define RDD_PARSER_RESULTS_MAC_SA3_6_WRITE_G(v, g, idx)                 GROUP_MWRITE_32(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 16, v)
...
#define RDD_PARSER_RESULTS_ICMPV6_TYPE_READ_G(r, g, idx)                GROUP_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 20, r)
#define RDD_PARSER_RESULTS_ICMPV6_TYPE_WRITE_G(v, g, idx)               GROUP_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 20, v)
...
#define RDD_PARSER_RESULTS_IP_TTL_READ_G(r, g, idx)                     GROUP_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 21, r)
#define RDD_PARSER_RESULTS_IP_TTL_WRITE_G(v, g, idx)                    GROUP_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 21, v)
...
#define RDD_PARSER_RESULTS_IP_LENGTH_READ_G(r, g, idx)                  GROUP_MREAD_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 22, r)
#define RDD_PARSER_RESULTS_IP_LENGTH_WRITE_G(v, g, idx)                 GROUP_MWRITE_16(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 22, v)
...
#define RDD_PARSER_RESULTS_IP_FILTER_MATCH_READ_G(r, g, idx)            GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 7, 1, r)
#define RDD_PARSER_RESULTS_IP_FILTER_MATCH_WRITE_G(v, g, idx)           GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 7, 1, v)
...
#define RDD_PARSER_RESULTS_IP_FILTER_NUM_READ_G(r, g, idx)              GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 6, 1, r)
#define RDD_PARSER_RESULTS_IP_FILTER_NUM_WRITE_G(v, g, idx)             GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 6, 1, v)
...
#define RDD_PARSER_RESULTS_P_TAG_READ_G(r, g, idx)                      GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 5, 1, r)
#define RDD_PARSER_RESULTS_P_TAG_WRITE_G(v, g, idx)                     GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 5, 1, v)
...
#define RDD_PARSER_RESULTS_VID_FILTER_HIT_READ_G(r, g, idx)             GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 4, 1, r)
#define RDD_PARSER_RESULTS_VID_FILTER_HIT_WRITE_G(v, g, idx)            GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 4, 1, v)
...
#define RDD_PARSER_RESULTS_DA_FILTER_NUMBER_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 0, 4, r)
#define RDD_PARSER_RESULTS_DA_FILTER_NUMBER_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 24, 0, 4, v)
...
#define RDD_PARSER_RESULTS_TAG_TYPE_READ_G(r, g, idx)                   GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 25, 6, 2, r)
#define RDD_PARSER_RESULTS_TAG_TYPE_WRITE_G(v, g, idx)                  GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 25, 6, 2, v)
...
#define RDD_PARSER_RESULTS_TPID_VLAN_0_READ_G(r, g, idx)                GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 25, 3, 3, r)
#define RDD_PARSER_RESULTS_TPID_VLAN_0_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 25, 3, 3, v)
...
#define RDD_PARSER_RESULTS_TPID_VLAN_1_READ_G(r, g, idx)                GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 25, 0, 3, r)
#define RDD_PARSER_RESULTS_TPID_VLAN_1_WRITE_G(v, g, idx)               GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 25, 0, 3, v)
...
#define RDD_PARSER_RESULTS_VID_FILTER_MATCH_READ_G(r, g, idx)           GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 26, 4, 4, r)
#define RDD_PARSER_RESULTS_VID_FILTER_MATCH_WRITE_G(v, g, idx)          GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 26, 4, 4, v)
...
#define RDD_PARSER_RESULTS_DOS_ATTACK_REASON_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 26, 0, 4, r)
#define RDD_PARSER_RESULTS_DOS_ATTACK_REASON_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 26, 0, 4, v)
...
#define RDD_PARSER_RESULTS_LAYER2_ADDRESS_READ_G(r, g, idx)             GROUP_MREAD_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 27, r)
#define RDD_PARSER_RESULTS_LAYER2_ADDRESS_WRITE_G(v, g, idx)            GROUP_MWRITE_8(g, idx*sizeof(PARSER_RESULTS_STRUCT) + 27, v)
...
#define RDD_PARSER_L2_LKP_ENTRY_VLAN_ETH_TYPE_CRC_READ_G(r, g, idx)          GROUP_MREAD_32(g, idx*sizeof(PARSER_L2_LKP_ENTRY_STRUCT) + 8, r)
#define RDD_PARSER_L2_LKP_ENTRY_VLAN_ETH_TYPE_CRC_WRITE_G(v, g, idx)         GROUP_MWRITE_32(g, idx*sizeof(PARSER_L2_LKP_ENTRY_STRUCT) + 8, v)
...
#define RDD_PARSER_L3_LKP_ENTRY_SOURCE_IP_READ_G(r, g, idx)                 GROUP_MREAD_32(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT), r)
#define RDD_PARSER_L3_LKP_ENTRY_SOURCE_IP_WRITE_G(v, g, idx)                GROUP_MWRITE_32(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT), v)
...
#define RDD_PARSER_L3_LKP_ENTRY_DESTINATION_IP_READ_G(r, g, idx)            GROUP_MREAD_32(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT) + 4, r)
#define RDD_PARSER_L3_LKP_ENTRY_DESTINATION_IP_WRITE_G(v, g, idx)           GROUP_MWRITE_32(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT) + 4, v)
...
#define RDD_PARSER_L3_LKP_ENTRY_SOURCE_PORT_READ_G(r, g, idx)               GROUP_MREAD_16(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT) + 8, r)
#define RDD_PARSER_L3_LKP_ENTRY_SOURCE_PORT_WRITE_G(v, g, idx)              GROUP_MWRITE_16(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT) + 8, v)
...
#define RDD_PARSER_L3_LKP_ENTRY_DESTINATION_PORT_READ_G(r, g, idx)          GROUP_MREAD_16(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT) + 10, r)
#define RDD_PARSER_L3_LKP_ENTRY_DESTINATION_PORT_WRITE_G(v, g, idx)         GROUP_MWRITE_16(g, idx*sizeof(PARSER_L3_LKP_ENTRY_STRUCT) + 10, v)
...
#define RDD_PARSER_IC_LKP_ENTRY_SOURCE_IP_READ_G(r, g, idx)                 GROUP_MREAD_32(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 8, r)
#define RDD_PARSER_IC_LKP_ENTRY_SOURCE_IP_WRITE_G(v, g, idx)                GROUP_MWRITE_32(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 8, v)
...
#define RDD_PARSER_IC_LKP_ENTRY_DESTINATION_IP_READ_G(r, g, idx)            GROUP_MREAD_32(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 12, r)
#define RDD_PARSER_IC_LKP_ENTRY_DESTINATION_IP_WRITE_G(v, g, idx)           GROUP_MWRITE_32(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 12, v)
...
#define RDD_PARSER_IC_LKP_ENTRY_SOURCE_PORT_READ_G(r, g, idx)               GROUP_MREAD_16(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 16, r)
#define RDD_PARSER_IC_LKP_ENTRY_SOURCE_PORT_WRITE_G(v, g, idx)              GROUP_MWRITE_16(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 16, v)
...
#define RDD_PARSER_IC_LKP_ENTRY_DESTINATION_PORT_READ_G(r, g, idx)          GROUP_MREAD_16(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 18, r)
#define RDD_PARSER_IC_LKP_ENTRY_DESTINATION_PORT_WRITE_G(v, g, idx)         GROUP_MWRITE_16(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 18, v)
...
#define RDD_PARSER_IC_LKP_ENTRY_TOS_READ_G(r, g, idx)                       GROUP_MREAD_8(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 30, r)
#define RDD_PARSER_IC_LKP_ENTRY_TOS_WRITE_G(v, g, idx)                      GROUP_MWRITE_8(g, idx*sizeof(PARSER_IC_LKP_ENTRY_STRUCT) + 30, v)
...
#define RDD_HASH_COMMAND_KEY_1_READ_G(r, g, idx)                  GROUP_MREAD_32(g, idx*sizeof(HASH_COMMAND_STRUCT), r)
#define RDD_HASH_COMMAND_KEY_1_WRITE_G(v, g, idx)                 GROUP_MWRITE_32(g, idx*sizeof(HASH_COMMAND_STRUCT), v)
#define RDD_HASH_COMMAND_KEY_1_READ(r, p)                         MREAD_32((uint8_t *)p, r)
#define RDD_HASH_COMMAND_KEY_1_WRITE(v, p)                        MWRITE_32((uint8_t *)p, v)
#define RDD_HASH_COMMAND_KEY_0_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_32(g, idx*sizeof(HASH_COMMAND_STRUCT) + 4, 4, 28, r)
#define RDD_HASH_COMMAND_KEY_0_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_32(g, idx*sizeof(HASH_COMMAND_STRUCT) + 4, 4, 28, v)
...
#define RDD_HASH_COMMAND_CONFIGURATION_READ_G(r, g, idx)          GROUP_FIELD_MREAD_8(g, idx*sizeof(HASH_COMMAND_STRUCT) + 7, 1, 3, r)
#define RDD_HASH_COMMAND_CONFIGURATION_WRITE_G(v, g, idx)         GROUP_FIELD_MWRITE_8(g, idx*sizeof(HASH_COMMAND_STRUCT) + 7, 1, 3, v)
...
#define RDD_HASH_COMMAND_AGING_READ_G(r, g, idx)                  GROUP_FIELD_MREAD_8(g, idx*sizeof(HASH_COMMAND_STRUCT) + 7, 0, 1, r)
#define RDD_HASH_COMMAND_AGING_WRITE_G(v, g, idx)                 GROUP_FIELD_MWRITE_8(g, idx*sizeof(HASH_COMMAND_STRUCT) + 7, 0, 1, v)

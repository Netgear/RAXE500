...
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT CPU_TX_SCRATCHPAD =
{
	4,
	{
...
static DUMP_RUNNERREG_STRUCT BBH_TX_RING_TABLE =
{
	16,
	{
		{ dump_RDD_BBH_TX_DESCRIPTOR, 0xd60 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT BBH_TX_BB_DESTINATION_TABLE =
{
	4,
	{
		{ dump_RDD_BB_DESTINATION_ENTRY, 0xd7c },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RX_CFE_SRAM_COUNTERS =
{
	8,
	{
		{ dump_RDD_PACKETS_AND_BYTES, 0xd80 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_RX_INTERRUPT_ID_DDR_ADDR =
{
	1,
	{
		{ dump_RDD_BYTE_1, 0xde8 },
		{ 0, 0 },
	}
};
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT PKT_BUFFER_ALLOC_MAP_TABLE =
{
	4,
	{
...
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT CPU_RX_LAST_READ_INDEX =
{
	2,
	{
		{ dump_RDD_BYTES_2, 0xdfc },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT CPU_TX_CFE_SRAM_COUNTERS =
{
	8,
	{
		{ dump_RDD_PACKETS_AND_BYTES, 0xe00 },
		{ 0, 0 },
	}
};
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT CPU_RX_BB_REPLY_ADDR_TABLE =
{
	4,
	{
...
#endif
#if defined XRDP_CFE
static DUMP_RUNNERREG_STRUCT CPU_TX_BB_REPLY_ADDR_TABLE =
{
	4,
	{
		{ dump_RDD_BYTES_4, 0xe58 },
		{ 0, 0 },
	}
};
#endif
...
static DUMP_RUNNERREG_STRUCT DS_TM_BBH_TX_EGRESS_COUNTER_TABLE =
{
	8,
	{
		{ dump_RDD_BBH_TX_EGRESS_COUNTER_ENTRY, 0xe80 },
		{ 0, 0 },
	}
};
#endif
...
{
#if defined XRDP_CFE
	{ "SRAM_PD_FIFO", 1, CORE_0_INDEX, &SRAM_PD_FIFO, 16, 1, 1 },
#endif
#if defined XRDP_CFE
...
#endif
#if defined XRDP_CFE
	{ "CPU_RX_SCRATCHPAD", 1, CORE_0_INDEX, &CPU_RX_SCRATCHPAD, 384, 1, 1 },
#endif
#if defined XRDP_CFE
	{ "CPU_TX_SCRATCHPAD", 1, CORE_0_INDEX, &CPU_TX_SCRATCHPAD, 384, 1, 1 },
#endif
#if defined XRDP_CFE
...
#endif
#if defined XRDP_CFE
	{ "PKT_BUFFER_ALLOC_MAP_TABLE", 1, CORE_0_INDEX, &PKT_BUFFER_ALLOC_MAP_TABLE, 3, 1, 1 },
#endif
#if defined XRDP_CFE
	{ "CPU_RX_LAST_READ_INDEX", 1, CORE_0_INDEX, &CPU_RX_LAST_READ_INDEX, 1, 1, 1 },
#endif
#if defined XRDP_CFE
...
#endif
#if defined XRDP_CFE
	{ "CPU_RX_BB_REPLY_ADDR_TABLE", 1, CORE_0_INDEX, &CPU_RX_BB_REPLY_ADDR_TABLE, 2, 1, 1 },
#endif
#if defined XRDP_CFE
	{ "CPU_TX_BB_REPLY_ADDR_TABLE", 1, CORE_0_INDEX, &CPU_TX_BB_REPLY_ADDR_TABLE, 2, 1, 1 },
#endif
#if defined XRDP_CFE

...
#define IS_RDPA_WAN_TYPE_EPON(_if) ((rdpa_wan_type)(_if) == rdpa_wan_epon || (rdpa_wan_type)(_if) == rdpa_wan_xepon)
#define IS_RDPA_WAN_TYPE_GPON(_if) ((rdpa_wan_type)(_if) == rdpa_wan_gpon || (rdpa_wan_type)(_if) == rdpa_wan_xgpon)
...
typedef enum
{
    ...
    rdpa_if_lan_sys_port = rdpa_if_lan29, /* used fore DPU project */
...
#elif defined(WL4908) || defined(CHIP_4908) || defined(BCM4912) || defined(CHIP_4912)
   switch (__wan) {
      case rdpa_wan_gbe       :
         return (rdpa_if_wan0);
      default                 :
...
#elif defined(BCM63146) || defined(CHIP_63146)
   switch (__wan) {
      case rdpa_wan_gbe       :
         return (rdpa_if_wan0);
      case rdpa_wan_dsl       :

...
#if defined(CONFIG_BCM96858) && !defined(BDMF_SYSTEM_SIM)
...
#if defined(BDMF_SYSTEM_SIM) && !defined(WL4908) && !defined(BCM_DSL_XRDP)
...
#endif
#if !defined(WL4908) && !defined(BCM_DSL_XRDP)

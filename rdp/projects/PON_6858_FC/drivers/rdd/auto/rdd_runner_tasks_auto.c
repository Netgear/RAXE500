...
char *image_task_names[5][16] = {
	...
	{"US_TM_WAN_DIRECT", "US_TM_BUDGET_ALLOCATION", "US_TM_OVL_BUDGET_ALLOCATION", "US_TM_BUFFER_CONG_MGT", "US_TM_UPDATE_FIFO", "US_TM_UPDATE_FIFO_EPON", "US_TM_FLUSH", "US_TM_WAN_0", "", "", "US_TM_WAN_EPON", "", "", "", "", ""},

...
#define NATC_16BYTE_KEY_MASK                                    {.data={0x0000000f, 0x00000000, 0x00000000, 0x00000000, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff}}
#else
...
#define RDD_TM_FLOW_CNTR_TABLE_SIZE      (RDD_US_TM_DSL_TM_FLOW_CNTR_TABLE_SIZE + RDD_US_TM_ETH_TM_FLOW_CNTR_TABLE_SIZE)

...
#define CONFIG_SYS_INIT_SP_ADDR \
	(CONFIG_SYS_INIT_RAM_ADDR_VIRT + CONFIG_SYS_INIT_SP_OFFSET)
#define CONFIG_SYS_INIT_SP_OFFSET	0x0
*/
#define CONFIG_SYS_INIT_SP_ADDR		0x822bfff0 /*0x822b9000+0x8000+0x9800*/
#define CONFIG_SYS_PAGETBL_BASE		0x7fff0000
#define CONFIG_SYS_PAGETBL_SIZE		0x10000

#define CONFIG_SPL_MAX_SIZE		0x00019000
/* framing bss right after bss text+data*/
#define CONFIG_SPL_BSS_START_ADDR	0x822b9000
/*#define CONFIG_SPL_BSS_START_ADDR	0x822c0000*/
#define CONFIG_SPL_BSS_MAX_SIZE		0x8000
#define CONFIG_SYS_MALLOC_SIMPLE
/*STACK_LEN +  CONFIG_SPL_SYS_R_MALLOC_SIMPLE_LEN + GLB DATA 
 * 0x1000   +  0x8000  + 0x800 (GLB?) = 0x9800
 * */
#define CONFIG_SPL_STACK_R_ADDR		0x822ccf00 /*0x822b9000+0x8000+0x9800*/
